...
<head>
  ...
  <title>Mohamed ControlPanel</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3 mt-3">Mohamed DashBoard</div>
      </a>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="{{ route('blogs_path_index1') }}">
          <i class="fas fa-fw fa-admin-alt"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Mohamed Monia</span>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          ...
          <span>Copyright &copy; Mohamed Monia {{date('Y')}} </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
