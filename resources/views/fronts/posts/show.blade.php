	    ...
	    <article class="blog-post px-3 py-5 p-md-5">
		    <div class="container">
			    <header class="blog-post-header">
				    ...
				    <div class="meta mb-3"><span class="date">Published {{ $blog->created_at->diffForHumans() }}.</span></div>
			    </header>
			    
			    <div class="blog-post-body">
				    <figure class="blog-banner">
				        <a href="https://made4dev.com"><img class="img-fluid" src="{{ $blog->image }}" alt="image"></a>
				    </figure>
                  ...
                  <input type="text" name="comment_body" class="form-control @error('comment_body') is-invalid @enderror" placeholder="write a comment ...">
                    ...
                    <button type="submit" class="btn btn-outline-primary"><i class="far fa-comment-dots"></i></button>
                    </div>
                    ...
                    <div class="cc">
                        ...
                        <div class="meta mb-3"> 
                            <p style="color: black; background-color: #fffedc;">{{ $comment->comment_body }}</p>
                            <span class="date">Published {{ $comment->created_at->diffForHumans() }}</span>
                        </div>     
                        @endforeach 
                    </div>
				    					    
				    <h3 class="mt-5 mb-3">{{ $blog->video_title }}</h3>
				    <p>{!! $blog->video_content !!}</p>

				    <div class="embed-responsive embed-responsive-16by9">
					   <iframe width="560" height="315" src="{{ $blog->video_path }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>					
					</div>
